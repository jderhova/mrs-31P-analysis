#16x16x8 CSI: Phantom second acquisition wires removed from room
#16-rung birdcage/24-channel array
...
data= suspect.io.load_twix('/Users/johnnyderhovagimian/Desktop/31PMRS_Data/31P_Data_24Channel/Feb_15/meas_MID00050_FID15972_csi_fid_16x16_sag_fov300.dat')
...
for i in range(16):
    for j in range(8):
        for k in range(16):
            SNR_map[i,j,k]= np.sum(np.real(spectrum_cc_wfp[i,j,k][481:540]))
...
fig4=plt.figure()
snr_plot2=plt.imshow(SNR_map[:,:,7])
