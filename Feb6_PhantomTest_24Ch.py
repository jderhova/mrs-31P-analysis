...
data= suspect.io.load_twix('/Users/johnnyderhovagimian/Desktop/31PMRS_Data/31P_Data_24Channel/Feb_6/meas_MID00037_FID15208_csi_fid_16x16.dat')
...
for i in range(16):
    for j in range(8):
        for k in range(16):
            SNR_map[i,j,k]= np.sum(np.real(spectrum_cc_wfp[i,j,k][490:540]))
...
fig4=plt.figure()
snr_plot2=plt.imshow(SNR_map[:,3,:])
